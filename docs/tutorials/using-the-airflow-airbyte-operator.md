---
description: Start triggering Airbyte jobs with Airflow in minutes
---
...
{% hint style="warning" %}
This tutorial is a preview. The Airbyte Operator is [code complete](https://github.com/apache/airflow/pull/14492) and will be available in a couple of weeks with Airflow's next release.
{% endhint %}
...
If this is your first time using Airbyte, we suggest going through our [Basic Tutorial](https://github.com/airbytehq/airbyte/tree/2f3a1f0f74375da6c94f135ad9449baffc75e85c/docs/quickstart/getting-started.md). This tutorial will use the Connection set up in the basic tutorial.
