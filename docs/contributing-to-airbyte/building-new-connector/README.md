...
Airbyte supports two types of connectors: Sources and Destinations. A connector takes the form of a Docker image which follows the [Airbyte specification](../../reference/architecture/airbyte-specification.md).
...
Before building a new connector, review [Airbyte's data protocol specification](../../reference/architecture/airbyte-specification.md).
